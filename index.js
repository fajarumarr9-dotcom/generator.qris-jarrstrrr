...
// KONFIGURASI - API KEY SUDAH DIGANTI YANG AWALAN 3
const FEE = 123;
...
app.post('/buat', async (req, res) => {
  try {
    ...
    if (isNaN(nominalAwal) || nominalAwal <= 0) {
      return res.send(`<div class="p-6 text-center"><h3 class="text-red-500">❌ Masukkan nominal yang valid</h3><a href="/" class="text-green-600">Kembali</a></div>`);
    }
